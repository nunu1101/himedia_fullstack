...
public class Application {
    ...
    public static void main(String[] args) {
        /* 수업목표. 객체지향 프로그래밍에 대해 이해하고 객체롸 클래스를 설계하여 프로그래밍 할 수 있다. */
         ...
         *  현실세계에서 불가능한 무생물이나 개념 같은 존재들도 하나의 주제조
        ...
        /* 객체를 설계하기 위해서는 복잡한 헌실세계를 그대로 반영하기에는 너무 방대하고 복잡하기 때문에
         * 현실 세계를 프로그램의 목적에 맞게 단순화하는 추상화하는 기법을 적용하게 된다.
         */
        ...
        /* 객체와 객체의 상호작용이란?
         *  객체와 객체는 메시지를 통해 서로 상호작용을 한다. 메시지(메소드 호출)를 보내는 쪽을 송신자라고 하고
         *  메세지를 수신하는 쪽은 수신자라고 한다.수신자는 메세지를 전달 받아 그 메세지에 해당하는 내용을 처리하는 방법을
         ...
         *  4. 카레이서는 먼저 다동차에 시동을 건다. 이미 걸려있는 경우 다시 시동을 걸 수 없다.
